...
<table id="menu-table" width="100%" cellpadding="0" cellspacing="0">
        <tbody><tr>
            <td class="menu2" id="menu2">
                <div style="padding: 12px 0px 0px 12px;">
                    <input name="ctl00$ctl00$BodyContentPlaceholder$SearchTextBox" type="text" id="SearchTextBox">
                </div>
		...
		<div class="vpad16">
		<input name="ctl00$ctl00$BodyContentPlaceholder$BodyContentPlaceholder$ctl00$ctl08" type="button" class="menu" title="ALT + A" onclick="return(addNew());" value="Add New">
