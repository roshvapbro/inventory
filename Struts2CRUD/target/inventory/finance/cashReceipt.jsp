...
<table border="0">
<tr>
<td><s:select   key="cashreceipt.trans.acId"  style='width: 300px;' list="transhead"  listKey="acId"  headerKey="" headerValue="Select" listValue="acHead" name="id"
...
<tr>
<td><s:select key="cashreceipt.ledger.ledgerId"   style='width: 300px;' list="ledgerheads" listKey="ledgerId" headerKey="" headerValue="Select" listValue="ledgerHead" name="lid"
